...
async function loadCloudFeatures(baseFeatures) {
  ...
  if (rows.length > 0) {
    setStorageStatus('Mode penyimpanan: Supabase online. Data bisa diedit bersama.');
  ...
  setStorageStatus('Mode penyimpanan: Supabase online. Data awal berhasil disiapkan.');
